    ...
    <div className="h-screen flex flex-col p-4 bg-gray-900 text-white">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <p className="text-white font-bold">Execute Code:</p>
          <Play
            onClick={handleExecuteCode}
            size={"2rem"}
            className="bg-green-500 border rounded-full p-1 cursor-pointer hover:bg-green-600 transition-colors"
          />
        </div>
      </div>
      ...
      <div className="mt-4">
        ...
        <div className="w-full bg-gray-800 text-white p-4 my-2 h-36 overflow-y-auto rounded-lg">
          <pre>{output}</pre>
        </div>
      </div>
    </div>
